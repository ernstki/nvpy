...
class Config:
    ...
    def __init__(self, app_dir: str, cfg_files: typing.Optional[PathList] = None):
        ...
        self.console_debug = cp.getint(cfg_sec, 'console_debug')
...
class Controller:
    ...
    def __init__(self, config: Config):
        ...
        # file will be truncated when it reaches 100 kB
...
def parse_cmd_line_args(args: typing.Optional[typing.List] = None) -> argparse.Namespace:
    ...
    parser.add_argument('--config', '--cfg', '-c', dest='cfg', type=pathlib.Path,
                        metavar='nvpy.cfg', help='path to config file')
    parser.add_argument('--debug', '-d', dest='console_debug',
                        action='store_true', help='enable debugging to console')
